...
#defining the model
model = StandardABM(Agent; properties=Ambiguity_properties, scheduler=Schedulers.Randomly(),  model_step! = ambiguity_model_step!)
...
plot!(p2, data_model.pct_COND, label="Stern Judging", title="Population composition over time(AMBIGUITY)")
